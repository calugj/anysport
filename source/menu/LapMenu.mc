    ...
    public function initialize() {
        ...
        if(lapActivated) {
            ...
            if(autoLapActivated) {
                ...
                if(SportData.getInstance().isNauticalActivity()) {
...
public class LapMenuDelegate extends Menu2InputDelegate {
    ...
    public function onSelect(item as MenuItem) as Void {
        ...
        switch(id) {
            case :lapActive:
                flag = Properties.getValue("LapActivated");
                ...
                break;
            case :lapScreen:
                flag = Properties.getValue("LapScreen");
            ...
            case :lapField:
                ...
                menu = MenuUtils.setFocus(menu, Properties.getValue("LapScreenField"));
                WatchUi.pushView(menu, new LapFieldSettingMenuDelegate(), WatchUi.SLIDE_LEFT);
                break;
            case :autoLapActive:
                flag = Properties.getValue("AutoLapActivated");
            ...
            case :autoLapValue:
                ...
                var initial = Properties.getValue("AutoLapValue");
