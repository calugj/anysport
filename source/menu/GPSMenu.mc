...
public class GPSMenu extends MenuBaseClass {
    ...
    public function initialize() {
        var title = WatchUi.loadResource(Rez.Strings.Positioning);
        ...
        if(Toybox.Position has :CONFIGURATION_GPS && Position.hasConfigurationSupport(Position.CONFIGURATION_GPS)) {
            addItem(new CustomLabelSublabelMenuItem(Position.CONFIGURATION_GPS, "GPS", WatchUi.loadResource($.Rez.Strings.SingleBand)));
        }
        if(Toybox.Position has :CONFIGURATION_GPS_GLONASS && Position.hasConfigurationSupport(Position.CONFIGURATION_GPS_GLONASS)) {
            addItem(new CustomLabelSublabelMenuItem(Position.CONFIGURATION_GPS_GLONASS, "GLONASS", WatchUi.loadResource($.Rez.Strings.SingleBand)));
        }
        if(Toybox.Position has :CONFIGURATION_GPS_GALILEO && Position.hasConfigurationSupport(Position.CONFIGURATION_GPS_GALILEO)) {
            addItem(new CustomLabelSublabelMenuItem(Position.CONFIGURATION_GPS_GALILEO, "GALILEO", WatchUi.loadResource($.Rez.Strings.SingleBand)));
        }
        if(Toybox.Position has :CONFIGURATION_GPS_BEIDOU && Position.hasConfigurationSupport(Position.CONFIGURATION_GPS_BEIDOU)) {
            addItem(new CustomLabelSublabelMenuItem(Position.CONFIGURATION_GPS_BEIDOU, "BEIDOU", WatchUi.loadResource($.Rez.Strings.SingleBand)));
        }
        if(Toybox.Position has :CONFIGURATION_GPS_GLONASS_GALILEO_BEIDOU_L1 && Position.hasConfigurationSupport(Position.CONFIGURATION_GPS_GLONASS_GALILEO_BEIDOU_L1)) {
            addItem(new CustomLabelSublabelMenuItem(Position.CONFIGURATION_GPS_GLONASS_GALILEO_BEIDOU_L1, "All Systems", WatchUi.loadResource($.Rez.Strings.SingleBand)));
        }
        if(Toybox.Position has :CONFIGURATION_GPS_GLONASS_GALILEO_BEIDOU_L1_L5 && Position.hasConfigurationSupport(Position.CONFIGURATION_GPS_GLONASS_GALILEO_BEIDOU_L1_L5)) {
            addItem(new CustomLabelSublabelMenuItem(Position.CONFIGURATION_GPS_GLONASS_GALILEO_BEIDOU_L1_L5, "All Systems", WatchUi.loadResource($.Rez.Strings.MultiBand)));
        }
